...
public class Weather implements Serializable {
     ...
     *
     * @return countryCode | international country code displaying the country
     *         the city is located in as a String
     */
     ...
     *
     * @return weatherDesc | short description for the current weather situation
     *         as a String
     */
     ...
     *
     * @param wDesc | String value
     */
    public void setWeatherDesc(final String wDesc) {
     ...
     *
     * @param hum | integer value
     */
    public void setHumidity(final int hum) {
        this.humidity = hum;
    }
     ...
     *
     * @param pres | integer value
     */
    public void setPressure(final int pres) {
        this.pressure = pres;
    }
     ...
     * @param sRise | Date
     */
    public void setSunrise(final int sRise) {
        logger.info("sunrise as in:" + Integer.toString(sRise));
        this.sunrise = new Date(sRise);
     ...
     * @param sSet | Date
     */
    public void setSunset(final int sSet) {
        logger.info("sunset as in:" + Integer.toString(sSet));
        this.sunset = new Date(sSet);
     ...
     *
     * @param wSpeed | String value
     */
    public void setWindSpeed(final double wSpeed) {
